package com.qtkai.zhong.testutil

import com.qtkai.zhong.data.Conversation
import com.qtkai.zhong.data.DataRepository
import com.qtkai.zhong.data.EmailAccount
import com.qtkai.zhong.data.EmailSyncState
import com.qtkai.zhong.data.FallbackStatus
import com.qtkai.zhong.data.FreeMode
import com.qtkai.zhong.data.HeartbeatConfig
import com.qtkai.zhong.data.HeartbeatLogEntry
import com.qtkai.zhong.data.ImportSection
import com.qtkai.zhong.data.MemoryEntry
import com.qtkai.zhong.data.ScheduledTask
import com.qtkai.zhong.data.Service
import com.qtkai.zhong.data.ServiceEntry
import com.qtkai.zhong.data.ServiceInstance
import com.qtkai.zhong.data.SmsDraft
import com.qtkai.zhong.data.SmsSyncState
import com.qtkai.zhong.data.SystemPromptVariant
import com.qtkai.zhong.data.ThemeMode
import com.qtkai.zhong.data.ensureSelectedModelPresent
...
class FakeDataRepository : DataRepository {
    ...
    override suspend fun ask(
        ...
        uiSubmission: com.qtkai.zhong.data.UiSubmission?,
    ...
    var skills: List<com.qtkai.zhong.skills.SkillManifest> = emptyList()

    override fun getInstalledSkills(): List<com.qtkai.zhong.skills.SkillManifest> = skills
    override suspend fun uninstallSkill(id: String) {}
    override suspend fun browseSkillMarketplaces(): Result<List<com.qtkai.zhong.skills.RegistrySkillEntry>> = Result.success(emptyList())
    override suspend fun installBrowsedSkill(entry: com.qtkai.zhong.skills.RegistrySkillEntry): Result<com.qtkai.zhong.skills.SkillManifest> = Result.failure(NotImplementedError())
    override suspend fun installGitHubSkill(owner: String, repo: String, ref: String, path: String): Result<com.qtkai.zhong.skills.SkillManifest> = Result.failure(NotImplementedError())
    ...
    override fun getNotificationSyncState(): com.qtkai.zhong.data.NotificationSyncState = com.qtkai.zhong.data.NotificationSyncState()
