...
import com.qtkai.zhong.sandbox.SessionShell
...
class AndroidSandboxController : SandboxController {
    ...
    override fun transcriptFor(sessionId: String): SnapshotStateList<com.qtkai.zhong.TerminalLine> = sandboxManager.transcriptFor(sessionId)
