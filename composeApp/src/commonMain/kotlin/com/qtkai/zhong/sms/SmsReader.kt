package com.qtkai.zhong.sms

import com.qtkai.zhong.data.SmsMessage
...
expect class SmsReader() {
    ...
    /**
     * The current maximum inbox `_id`. Used to seed [com.qtkai.zhong.data.SmsSyncState.lastSeenId]
