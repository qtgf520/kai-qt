...
interface DataRepository {
    ...
    /** Conversation id that currently has an in-flight (unfinished) turn/task. */
    val activeTurnConversationId: StateFlow<String?>
    ...
    /** Renames the display-name / note of a service instance; null clears it. */
    fun renameServiceInstance(instanceId: String, displayName: String?)
